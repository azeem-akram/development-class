        ...
        <div class="col col-xl-10">
            ...
            <div class="row g-0">
                ...
                <div class="card-body p-4 p-lg-5 text-black">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <input type="text" name="first_name" id="form2Example17" class="form-control form-control-lg" required/>
                            <label class="form-label" for="form2Example17">First Name</label>
                        </div>
                        <div class="col-md-6">
                            <input type="text" name="last_name" id="form2Example17" class="form-control form-control-lg" required/>
                    ...
                    <div class="form-outline mb-4">
                        <input type="password" name="password2" id="form2Example27" class="form-control form-control-lg" required/>
                        <label class="form-label" for="form2Example27">Confirm Password</label>
                    </div>

                    <div class="pt-1 mb-4">
                        <button type="submit" name="register" class="btn btn-dark btn-lg btn-block" type="button">Register</button>
                    </div>
