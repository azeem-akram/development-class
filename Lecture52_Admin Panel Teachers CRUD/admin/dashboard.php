  ...
  <body>
    ...
    <div class="main-content">
        ...
        <div class="content-main">
            <div class="row">
              <div class="col-md-6">
                <div class="stat" style="background-color: #0784e7;">
                  <h3><?php echo $noOfStudents ?></h3>
                  Students Registered
                  <hr>
              ...
              <div class="col-md-6">
                <div class="stat" style="background-color: rgb(255,193,5);">
                    <h3>15</h3>
                    Classes
                    <hr>
                    <a href="">View Details</a>
              ...
              <div class="col-md-6">
                <div class="stat" style="background-color: rgb(220,53,69);">
                  <h3>5</h3>
