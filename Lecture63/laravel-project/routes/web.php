...
Route::get('/get-all-teachers', [TeacherController::class, 'index'])->name('teachers.index');
Route::post('/create-teacher', [TeacherController::class, 'create'])->name('teachers.create');

Route::put('/edit-teacher/{id}', [TeacherController::class, 'update']);
Route::delete('/delete-teacher/{id}', [TeacherController::class, 'delete']);


Route::get('/get-web-devs-teachers', [TeacherController::class, 'getWebDevsTeachers'])->name('teachers.webdevs');
