...
<body>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="<?php echo route('teachers.create') ?>">
    ...
    <h1><?php echo route('teachers.index') ?></h1>

    <a href="<?php echo route('teachers.webdevs') ?>" class="btn btn-info">Get Web Developement Teachers</a>
            ...
            <div class="teacher-box">
                ...
                <div>
                    ...
                    <div class="modal fade" id="editModel_<?php echo $t['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <form method="POST" action="/edit-teacher/<?php echo $t['id'] ?>">
                                <?php echo csrf_field() ?>
                    ...
                    <form method="POST" action="delete-teacher/<?php echo $t['id'] ?>">
                        <?php echo csrf_field() ?>
                        <?php echo method_field('DELETE') ?>
                        <button onclick="return confirm('Are you sure?')" type="submit" href="" class="btn btn-danger">Delete</button>
                    </form>
